  ...
  return (
    <div className="min-h-screen bg-[#090C11] text-white">
      ...
      <section id="about" className="pt-0 md:pt-20 pb-12 px-4 md:px-8 max-w-3xl mx-auto">
        <h1 className="text-2xl md:text-3xl font-bold mb-8 text-[#59C1C7]">De leukste Vlaamse nabespreking podcast over De Mol van GoPlay!</h1>
        <p className="text-lg text-gray-300 mb-12 space-y-4">
          <span className="block">Krijg je maar niet genoeg van De Mol 2024? Kan Café de Mol je honger naar theoriën en discussies maar niet stillen?</span>
        ...
        <div className="bg-slate-800/50 rounded-2xl p-8">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-2xl font-bold text-[#59C1C7] mb-3">
